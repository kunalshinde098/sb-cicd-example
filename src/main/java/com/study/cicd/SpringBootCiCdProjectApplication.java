...
public class SpringBootCiCdProjectApplication {
	private static Log logger = LogFactory.getLog(SpringBootCiCdProjectApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(SpringBootCiCdProjectApplication.class, args);
